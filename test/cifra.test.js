...
test('Brazilian notation is recognized',()=>{for(const chord of ['F7M','Am7M','G9M','Am9','C13','E7(4)','E7(9)','E7(b9)','Am7(9)','Am7/G','F#m7(b5)'])assert.equal(isChordToken(chord),true,chord);});
