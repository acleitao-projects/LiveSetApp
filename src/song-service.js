import {newSong} from './models.js?v=39';
import {repository,storageCapabilities,writeOpfsFile,readOpfsFile,removeOpfsPath} from './storage.js?v=39';
import {isMp3File,readMp3Metadata,rewriteMp3Metadata} from './id3.js?v=39';
