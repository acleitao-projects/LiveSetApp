import {newSong} from './models.js?v=40';
import {repository,storageCapabilities,writeOpfsFile,readOpfsFile,removeOpfsPath} from './storage.js?v=40';
import {isMp3File,readMp3Metadata,rewriteMp3Metadata} from './id3.js?v=40';
