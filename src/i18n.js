...
const DICTS = {
  en: {
    ...
    pitch_sync_label: 'Match playback pitch to transpose',
    pitch_sync_hint: 'Shifts the audio to the same key as the chart, up to ±{max} semitones. Beyond that only the chart transposes.',
    pitch_active: 'Playback is pitch-shifted to match the transpose.',
    pitch_over_cap: 'Chart transpose is beyond the ±3 audio limit — audio is shifted only by ±3.',
    // Duplicate + share
    duplicate: 'Duplicate',
  ...
  pt: {
    ...
    pitch_sync_label: 'Ajustar tom do áudio à transposição',
    pitch_sync_hint: 'Desloca o áudio para o mesmo tom da cifra, até ±{max} semitons. Além disso, apenas a cifra transpõe.',
    pitch_active: 'O áudio está com o tom deslocado para acompanhar a transposição.',
    pitch_over_cap: 'A transposição da cifra passou do limite de ±3 do áudio — o áudio só é deslocado em ±3.',
    duplicate: 'Duplicar',
