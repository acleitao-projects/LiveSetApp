...
const DICTS = {
  en: {
    ...
    audio_pitch_group: 'Audio pitch (±3 semitones)',
    audio_pitch_down: 'Lower audio pitch',
    audio_pitch_up: 'Raise audio pitch',
    // Duplicate + share
    duplicate: 'Duplicate',
  ...
  pt: {
    ...
    audio_pitch_group: 'Tom do áudio (±3 semitons)',
    audio_pitch_down: 'Diminuir tom do áudio',
    audio_pitch_up: 'Aumentar tom do áudio',
    duplicate: 'Duplicar',
